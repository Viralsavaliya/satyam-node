...
function verifyRefreshToken(req, res, next) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (tokens_.length > 1) {
            ...
            jwt.verify(token, process.env.JWT_REFRESH_SECRET, (err, user) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (err) {
                    ...
                    let midLayer = yield aes_1.default.decrypt(user.sub, process.env.OUTER_KEY_PAYLOAD);
                    req.userData = JSON.parse(yield aes_1.default.decrypt(midLayer, process.env.OUTER_KEY_USER));
